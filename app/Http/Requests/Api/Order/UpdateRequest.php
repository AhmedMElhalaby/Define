    ...
    public function run(): JsonResponse
    {
        ...
        switch ($this->status){
            ...
            case Constant::ORDER_STATUSES['Canceled']:{
                ...
                if ($Object->delegate){
                    Functions::SendNotification($Object->delegate,'Order Canceled','Customer Canceled the order !','إلغاء الطلب !','قام المستخدم بإلغاء الطلب',$Object->getId(),Constant::NOTIFICATION_TYPE['Order']);
                }
                break;
            }
