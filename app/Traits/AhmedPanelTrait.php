...
trait AhmedPanelTrait
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        return $request->preset($this,$request);
    }
    /**
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return $request->preset($this,$id,$request);
    }
    /**
     ...
     * @return Factory|View
     */
    public static function Fields($Field, $value,$lang,$Object = null){
        switch ($Field['type']){
            case 'date':
            ...
            case 'multi_checkbox':
                ...
                break;
            case 'textarea':
                return view('AhmedPanel.base.fields.textarea',compact('Field','value','lang','Object'));
                break;
            case 'image':
            ...
            case 'text':
            default :
                return view('AhmedPanel.base.fields.text',compact('Field','value','lang','Object'));
                break;
        }
    }
