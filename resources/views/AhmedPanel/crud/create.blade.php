                                ...
                                <div class="col-md-12" id="Roles">
                                    ...
                                    @foreach(\App\Models\Role::all() as $role)
                                        <div class="col-md-3">
                                            ...
                                            <label for="{{$role->getId()}}">{{app()->getLocale() =='ar'?$role->getName():$role->getName()}}</label>
                                        </div>
                                ...
                                <div class="col-md-12" id="Permission">
                                    ...
                                    @foreach(\App\Models\Permission::whereNull('parent_id')->get() as $permission)
                                        <div class="form-group col-md-12">
                                            ...
                                            <label for="permission{{$permission->getId()}}">{{app()->getLocale() =='ar'?$permission->getName():$permission->getName()}}</label>
                                        </div>
                                        @foreach(\App\Models\Permission::where('parent_id',$permission->getId())->get() as $cPermission)
                                            <div class="form-group col-md-3">
                                                ...
                                                <label for="permission{{$cPermission->getId()}}">{{app()->getLocale() =='ar'?$cPermission->getName():$cPermission->getName()}}</label>
                                            </div>
                                        @endforeach
                                    @endforeach
                                </div>
